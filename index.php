    ...
    <main class="principal">
            ...
            <nav class="modulos">
                ...
                <div class="modulo roxo">
                    ...
                    <ul>
                        ...
                        <li>
                            <a href="exercicio.php?dir=controle&file=operadoresRelacionais">
                        ...
                        <li>
                            <a href="exercicio.php?dir=controle&file=desafioOperadoresLogicos">
                                Desafio OP LOGICOS
                            </a>
                        </li>
                        <li>
        ...
        <div class="modulo azul">
            <h3>Array</h3>
                    <ul>
                        <li>
                            <a href="exercicio.php?dir=array&file=arrayBasico">
                               Switch
                            </a>
                        </li>
